...
import { CreateIterablePromise, ClientOptions } from '@algolia/client-common';
 ...
 * The client type.
 */
type SearchClient = ReturnType<typeof searchClient>;
declare function searchClient(appId: string, apiKey: string, options?: ClientOptions): {
    /**
    ...
    waitForTask({ indexName, taskID, maxRetries, timeout, }: WaitForTaskOptions, requestOptions?: _algolia_client_common.RequestOptions): Promise<GetTaskResponse>;
    waitForAppTask({ taskID, maxRetries, timeout, }: WaitForAppTaskOptions, requestOptions?: _algolia_client_common.RequestOptions): Promise<GetTaskResponse>;
    waitForApiKey({ operation, key, apiKey, maxRetries, timeout, }: WaitForApiKeyOptions, requestOptions?: _algolia_client_common.RequestOptions): Promise<GetApiKeyResponse | undefined>;
    browseObjects<T>({ indexName, browseParams, ...browseObjectsOptions }: BrowseOptions<BrowseResponse<T>> & BrowseProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<BrowseResponse<T>>;
    browseRules({ indexName, searchRulesParams, ...browseRulesOptions }: BrowseOptions<SearchRulesResponse> & SearchRulesProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<SearchRulesResponse>;
    browseSynonyms({ indexName, searchSynonymsParams, ...browseSynonymsOptions }: BrowseOptions<SearchSynonymsResponse> & SearchSynonymsProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<SearchSynonymsResponse>;
    chunkedBatch({ indexName, objects, action, waitForTasks, batchSize }: ChunkedBatchOptions, requestOptions?: _algolia_client_common.RequestOptions): Promise<BatchResponse[]>;
    saveObjects({ indexName, objects }: SaveObjectsOptions, requestOptions?: _algolia_client_common.RequestOptions): Promise<BatchResponse[]>;
    deleteObjects({ indexName, objectIDs }: DeleteObjectsOptions, requestOptions?: _algolia_client_common.RequestOptions): Promise<BatchResponse[]>;
    partialUpdateObjects({ indexName, objects, createIfNotExists }: PartialUpdateObjectsOptions, requestOptions?: _algolia_client_common.RequestOptions): Promise<BatchResponse[]>;
    replaceAllObjects({ indexName, objects, batchSize }: ReplaceAllObjectsOptions, requestOptions?: _algolia_client_common.RequestOptions): Promise<ReplaceAllObjectsResponse>;
    ...
    addApiKey(apiKey: ApiKey, requestOptions?: _algolia_client_common.RequestOptions): Promise<AddApiKeyResponse>;
    addOrUpdateObject({ indexName, objectID, body }: AddOrUpdateObjectProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<UpdatedAtWithObjectIdResponse>;
    appendSource(source: Source, requestOptions?: _algolia_client_common.RequestOptions): Promise<CreatedAtResponse>;
    assignUserId({ xAlgoliaUserID, assignUserIdParams }: AssignUserIdProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<CreatedAtResponse>;
    batch({ indexName, batchWriteParams }: BatchProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<BatchResponse>;
    batchAssignUserIds({ xAlgoliaUserID, batchAssignUserIdsParams }: BatchAssignUserIdsProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<CreatedAtResponse>;
    batchDictionaryEntries({ dictionaryName, batchDictionaryEntriesParams }: BatchDictionaryEntriesProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<UpdatedAtResponse>;
    browse<T>({ indexName, browseParams }: BrowseProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<BrowseResponse<T>>;
    clearObjects({ indexName }: ClearObjectsProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<UpdatedAtResponse>;
    clearRules({ indexName, forwardToReplicas }: ClearRulesProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<UpdatedAtResponse>;
    clearSynonyms({ indexName, forwardToReplicas }: ClearSynonymsProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<UpdatedAtResponse>;
    ...
    deleteApiKey({ key }: DeleteApiKeyProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<DeleteApiKeyResponse>;
    deleteBy({ indexName, deleteByParams }: DeleteByProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<DeletedAtResponse>;
    deleteIndex({ indexName }: DeleteIndexProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<DeletedAtResponse>;
    deleteObject({ indexName, objectID }: DeleteObjectProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<DeletedAtResponse>;
    deleteRule({ indexName, objectID, forwardToReplicas }: DeleteRuleProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<UpdatedAtResponse>;
    deleteSource({ source }: DeleteSourceProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<DeleteSourceResponse>;
    deleteSynonym({ indexName, objectID, forwardToReplicas }: DeleteSynonymProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<DeletedAtResponse>;
    getApiKey({ key }: GetApiKeyProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<GetApiKeyResponse>;
    getAppTask({ taskID }: GetAppTaskProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<GetTaskResponse>;
    getDictionaryLanguages(requestOptions?: _algolia_client_common.RequestOptions): Promise<Record<string, Languages>>;
    getDictionarySettings(requestOptions?: _algolia_client_common.RequestOptions): Promise<GetDictionarySettingsResponse>;
    getLogs({ offset, length, indexName, type }?: GetLogsProps, requestOptions?: _algolia_client_common.RequestOptions | undefined): Promise<GetLogsResponse>;
    getObject({ indexName, objectID, attributesToRetrieve }: GetObjectProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<Record<string, unknown>>;
    getObjects<T>(getObjectsParams: GetObjectsParams, requestOptions?: _algolia_client_common.RequestOptions): Promise<GetObjectsResponse<T>>;
    getRule({ indexName, objectID }: GetRuleProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<Rule>;
    getSettings({ indexName }: GetSettingsProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<SettingsResponse>;
    getSources(requestOptions?: _algolia_client_common.RequestOptions): Promise<Source[]>;
    getSynonym({ indexName, objectID }: GetSynonymProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<SynonymHit>;
    getTask({ indexName, taskID }: GetTaskProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<GetTaskResponse>;
    getTopUserIds(requestOptions?: _algolia_client_common.RequestOptions): Promise<GetTopUserIdsResponse>;
    getUserId({ userID }: GetUserIdProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<UserId>;
    hasPendingMappings({ getClusters }?: HasPendingMappingsProps, requestOptions?: _algolia_client_common.RequestOptions | undefined): Promise<HasPendingMappingsResponse>;
    listApiKeys(requestOptions?: _algolia_client_common.RequestOptions): Promise<ListApiKeysResponse>;
    listClusters(requestOptions?: _algolia_client_common.RequestOptions): Promise<ListClustersResponse>;
    listIndices({ page, hitsPerPage }?: ListIndicesProps, requestOptions?: _algolia_client_common.RequestOptions | undefined): Promise<ListIndicesResponse>;
    listUserIds({ page, hitsPerPage }?: ListUserIdsProps, requestOptions?: _algolia_client_common.RequestOptions | undefined): Promise<ListUserIdsResponse>;
    multipleBatch(batchParams: BatchParams, requestOptions?: _algolia_client_common.RequestOptions): Promise<MultipleBatchResponse>;
    operationIndex({ indexName, operationIndexParams }: OperationIndexProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<UpdatedAtResponse>;
    partialUpdateObject({ indexName, objectID, attributesToUpdate, createIfNotExists }: PartialUpdateObjectProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<UpdatedAtWithObjectIdResponse>;
    removeUserId({ userID }: RemoveUserIdProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<RemoveUserIdResponse>;
    replaceSources({ source }: ReplaceSourcesProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<ReplaceSourceResponse>;
    restoreApiKey({ key }: RestoreApiKeyProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<AddApiKeyResponse>;
    saveObject({ indexName, body }: SaveObjectProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<SaveObjectResponse>;
    saveRule({ indexName, objectID, rule, forwardToReplicas }: SaveRuleProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<UpdatedRuleResponse>;
    saveRules({ indexName, rules, forwardToReplicas, clearExistingRules }: SaveRulesProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<UpdatedAtResponse>;
    saveSynonym({ indexName, objectID, synonymHit, forwardToReplicas }: SaveSynonymProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<SaveSynonymResponse>;
    saveSynonyms({ indexName, synonymHit, forwardToReplicas, replaceExistingSynonyms }: SaveSynonymsProps, requestOptions?: _algolia_client_common.RequestOptions): Promise<UpdatedAtResponse>;
