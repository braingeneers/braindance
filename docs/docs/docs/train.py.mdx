...
<a href="https://github.com/braingeneers/brainloop/blob/main/brainloop/core/spikedetector/train.py#L0"><img align="right" style={{"float":"right"}} src="https://img.shields.io/badge/-source-cccccc?style=flat-square" /></a>
...
<a href="https://github.com/braingeneers/brainloop/blob/main/brainloop/core/spikedetector/train.py#L11"><img align="right" style={{"float":"right"}} src="https://img.shields.io/badge/-source-cccccc?style=flat-square" /></a>
...
Params:  General parameters:  recordings:  A list containing the recordings to use for training the detection model. The length recordings must be at least two.   Each element can be one of the following: 
 ...
 run_kilosort2 parameters  See brainloop.core.spikesorter.kilosort2.py 


---

<a href="https://github.com/braingeneers/brainloop/blob/main/brainloop/core/spikedetector/train.py#L223"><img align="right" style={{"float":"right"}} src="https://img.shields.io/badge/-source-cccccc?style=flat-square" /></a>
