...
Run from `proj/predictor/` (where `Dockerfile.mamba` lives):

```bash
cd /Users/hunterschweiger/Desktop/braingeneers/BrainDance-dev/proj/predictor && \
...
Replace `vNEW` with the new version tag. This build can take 5-15 minutes with cache.
