...
**Path:** `braindance/examples/ant_cpg_example.py`
**Module:** `braindance.examples.ant_cpg_example`
**Feature Area:** `Examples and Workshop`
**Entry point:** yes — main / module execution (static candidate)

## Overview
Runs Ant neural control with rhythmic CPG sensory stimulation and learned or direct motor decoding. Supports checkpoint resume and reusing another experiment's RT-Sort data instead of repeating recording and sorting.
...
- **Uses:** `AntCPGPhaseV3` from `braindance.core.phases_v3.phases3_ant_cpg` — imports (static evidence).
- **Uses:** `RTSortPhaseV3` from `braindance.core.phases_v3.phases_analysis_3` — imports (static evidence).
- **Shared data:** Optional RecordPhaseV3 -> RTSortPhaseV3 -> AntCPGPhaseV3.
...
- `braindance.core.phases_v3.phases3_ant_cpg.AntCPGPhaseV3` — intra-repo import; source import evidence.
...
> **Called by:** braindance/examples/ant_cpg_example.py:110 (named-call hint). **Side effects:** unclear — see source.
**Source:** `braindance/examples/ant_cpg_example.py:27`
### `run_ant_cpg_experiment(params, resume=False, name='ant_cpg', source_experiment=None)`
> Run an Ant experiment with CPG-driven sensory input.
> **Called by:** braindance/examples/ant_cpg_example.py:335 (named-call hint). **Side effects:** unclear — see source.
**Source:** `braindance/examples/ant_cpg_example.py:69`
...
| --phase-offsets,--reward-mode; trainer defaults adaptive_tetanus |
