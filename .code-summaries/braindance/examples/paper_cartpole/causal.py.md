...
**Path:** `braindance/examples/paper_cartpole/causal.py`
**Module:** `braindance.examples.paper_cartpole.causal`
**Feature Area:** `Examples and Workshop`
**Entry point:** yes — main / module execution (static candidate)

## Overview
Preserved GUI causal stage from proj/cartpole_v1/causal_analysis.py. Requires live Maxwell and the historical analysis dependencies.
...
> **Called by:** braindance/examples/paper_cartpole/causal.py:117 (named-call hint). **Side effects:** write call (static hint).
**Source:** `braindance/examples/paper_cartpole/causal.py:6`
