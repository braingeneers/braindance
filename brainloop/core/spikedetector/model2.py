"""
This is essentially the same as model.py except
    1. No longer needs the import of utils.py, plot.py, data.py, meta.py
    2. Class ModelSpikeSorter is updated for RT-Sort, most notably the new functions compile() and load_compiled()
"""
